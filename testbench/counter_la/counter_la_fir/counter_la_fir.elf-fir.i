# 0 "fir.c"
# 1 "/home/ubuntu/SoC/caravel-soc_fpga-lab-main_v1/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "fir.c"
# 1 "fir.h" 1
 ...
 *(((volatile uint32_t*)0x30000040)+1) = -10;
 *(((volatile uint32_t*)0x30000040)+2) = -9;
 *(((volatile uint32_t*)0x30000040)+3) = 23;
 *(((volatile uint32_t*)0x30000040)+4) = 56;
 *(((volatile uint32_t*)0x30000040)+5) = 63;
 *(((volatile uint32_t*)0x30000040)+6) = 56;
 *(((volatile uint32_t*)0x30000040)+7) = 23;
 *(((volatile uint32_t*)0x30000040)+8) = -9;
 *(((volatile uint32_t*)0x30000040)+9) = -10;
 *(((volatile uint32_t*)0x30000040)+10) = 0;
# 42 "fir.c"
...
# 88 "fir.c"
  (*(volatile uint32_t*)0x2600000c) = (*(volatile uint32_t*)0x30000084) << 16;
 }
# 223 "fir.c"
 Status = (*(volatile uint32_t*)0x30000000);
